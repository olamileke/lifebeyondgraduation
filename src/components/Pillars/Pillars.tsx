...
export const Pillars = () => {
  ...
  return (
    <section className="pt-10 sm:pt-12 sm:pb-14 md:py-24" id="community">
      <div className="mx-auto w-[85%] w-[90%] max-w-[1200px] grid grid-cols-12">
        <div className="col-span-12 md:col-span-4 order-2 md:order-none relative bottom-[3.5rem] sm:bottom-0 flex flex-col-reverse items-center md:block">
          <div className="md:absolute top-0 left-0 flex item-start gap-4">
            ...
            <p className="text-center md:text-left text-[17px] md:text-xl lg:text-lg text-[rgba(0,0,0,0.9)] sm:text-[rgba(0,0,0,0.8)] lg:text-[rgba(0,0,0,0.85)] font-light">
          ...
          <div className="md:absolute bottom-[11px] left-0 flex mb-4 md:mb-0 gap-3 md:gap-4">
            ...
            >
              <IoMdArrowBack className="text-white text-2xl md:text-4xl transition transition-transform duration-700 md:-rotate-45 md:group-hover:-rotate-0" />
            </span>
            <span
              className={`size-12 md:size-16 group flex justify-center items-center cursor-pointer transition transition-colors delay-200 block ${
            ...
            >
              <IoMdArrowUp className="text-white text-2xl md:text-4xl transition transition-transform duration-700 rotate-90 md:rotate-45 md:group-hover:rotate-90" />
            </span>
          </div>
        </div>
